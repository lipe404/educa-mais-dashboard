...
UI_LABEL_TICKET_MEDIO_COLUMN = "Ticket Médio por Parceiro"
UI_LABEL_CAPTADORES_TICKET_TITLE = "Ticket Médio por Parceiro por Captador"
UI_LABEL_CAPTADORES_TICKET_DESC = "Faturamento total dividido pelo número de parceiros únicos no período (indica o porte dos parceiros)."
UI_LABEL_TICKET_MEDIO = "Ticket Médio (R$)"
UI_LABEL_CAPTADORES_RADAR_TITLE = "Comparativo de Performance Multi-métrica (Radar)"
UI_LABEL_CAPTADORES_RADAR_DESC = "Comparação dos 6 captadores principais. Cada eixo é normalizado de 0 a 100% em relação ao melhor desempenho."
UI_LABEL_REVENUE_PER_CONTRACT_COLUMN = "Faturamento Médio por Contrato"
UI_LABEL_CAPTADORES_REV_CONTRACT_TITLE = "Faturamento Médio por Contrato por Captador"
UI_LABEL_CAPTADORES_REV_CONTRACT_DESC = "Faturamento total dividido pela quantidade de contratos no período."
UI_LABEL_REVENUE_PER_CONTRACT = "Faturamento por Contrato (R$)"
UI_LABEL_CAPTADORES_MONTHLY_TITLE = "Parceiros Captados por Mês por Captador"
UI_LABEL_CAPTADORES_MONTHLY_DESC = "Evolução temporal do número de novos parceiros com contrato assinado por captador."
UI_LABEL_CAPTADORES_CUMSUM_TITLE = "Faturamento Acumulado ao Longo do Tempo (Cumsum)"
UI_LABEL_CAPTADORES_CUMSUM_DESC = "Evolução do faturamento acumulado gerado pelos parceiros de cada captador."
UI_LABEL_CAPTADORES_BUMP_TITLE = "Ranking Mensal de Faturamento (Bump Chart)"
UI_LABEL_CAPTADORES_BUMP_DESC = "Ranking mensal de faturamento (quanto menor o rank, maior o faturamento no mês)."
UI_LABEL_CAPTADORES_HEATMAP_TITLE = "Heatmap: Mês x Captador"
UI_LABEL_CAPTADORES_HEATMAP_DESC = "Distribuição mensal de performance por captador."
UI_LABEL_CAPTADORES_AREA_TITLE = "Composição do Faturamento Mensal (Área Empilhada)"
UI_LABEL_CAPTADORES_AREA_DESC = "Composição do faturamento mensal total distribuído pelos captadores."
UI_LABEL_CAPTADORES_MOM_TITLE = "Taxa de Crescimento MoM (%) por Captador"
UI_LABEL_CAPTADORES_MOM_DESC = "Variação percentual mensal do faturamento (MoM) de cada captador."
UI_LABEL_CAPTADORES_GEO_HEADER = "Análise Geográfica de Captadores"
UI_LABEL_CAPTADORES_TREEMAP_TITLE = "Treemap Geográfico: Região → Estado → Captador"
UI_LABEL_CAPTADORES_HEATMAP_STATE_TITLE = "Heatmap: Estado x Captador (Domínio de Território)"
UI_LABEL_CAPTADORES_BAR_REG_TITLE = "Distribuição Regional por Captador"
UI_LABEL_CAPTADORES_DISPERSION_TITLE = "Índices de Dispersão Geográfica"
UI_LABEL_CAPTADORES_DISPERSION_DESC = "Herfindahl (HHI) Regional mede a concentração: quanto maior (até 10.000), mais regionalizado. Quanto menor, mais pulverizado pelo país."
UI_LABEL_CAPTADORES_PROJ_TITLE = "Projeção de Comissão (Mês Corrente)"
UI_LABEL_CAPTADORES_PROJ_DESC = "Comissão acumulada no mês versus projeção de fechamento baseado no ritmo diário atual."
UI_LABEL_CAPTADORES_WATERFALL_TITLE = "Waterfall: Contribuição de Faturamento"
UI_LABEL_CAPTADORES_WATERFALL_DESC = "Contribuição de faturamento de cada captador (valores incrementais e totalizador)."
UI_LABEL_CAPTADORES_SEASONALITY_TITLE = "Sazonalidade de Captações"
UI_LABEL_CAPTADORES_SEASONALITY_DESC = "Distribuição acumulada de novos parceiros por mês calendário ou trimestre."
